...
export const TEMPLATES: TemplateMeta[] = [
  // 1. New Masterclass Original Designs
  {
    slug: "neo-glassmorphism-executive",
    name: "Neo-Glassmorphism Executive",
    description: "Deep obsidian canvas with frosted glass cards and neon ambient orbs.",
    category: "executive",
    component: NeoGlassmorphismTemplate as unknown as ComponentType<TemplateProps>,
    atsSafe: false,
    supportsPhoto: true,
    suggestedRoles: ["cto", "vp-engineering", "chief-technology-officer"],
    suggestedIndustries: ["technology", "executive"],
    themes: ["midnight", "indigo", "cyan"],
  },
  {
    slug: "asymmetric-editorial",
    name: "Asymmetric Editorial Masthead",
    description: "Warm champagne and burnt wine magazine style with massive serif headers.",
    category: "creative",
    component: AsymmetricEditorialTemplate as unknown as ComponentType<TemplateProps>,
    atsSafe: true,
    supportsPhoto: false,
    suggestedRoles: ["editor-in-chief", "editorial-director", "journalist"],
    suggestedIndustries: ["editorial", "publishing"],
  ...
  },
  {
    ...
    atsSafe: false,
    supportsPhoto: false,
    suggestedRoles: ["cybersecurity-architect", "penetration-tester"],
    suggestedIndustries: ["cybersecurity", "technology"],
    themes: ["midnight", "cyan", "slate"],
  },
  {
    slug: "boho-organic-terracotta",
    name: "Boho Organic Terracotta",
    description: "Warm sand and soft clay organic curved blobs with mindful layout.",
    category: "creative",
    ...
    suggestedIndustries: ["design", "creative"],
    themes: ["terracotta", "sand", "ivory"],
  },

  // 2. Canva Imported Templates
  {
    ...
    atsSafe: false,
    supportsPhoto: true,
    suggestedRoles: ["graphiste", "designer-graphique", "art-director"],
  ...
  },
  {
    ...
    atsSafe: true,
    supportsPhoto: true,
    suggestedRoles: ["chargee-de-projet", "event-manager"],
    suggestedIndustries: ["events", "marketing"],
  ...
  },
  {
    ...
    suggestedIndustries: ["creative", "freelance"],
  ...
  },
  {
    ...
    atsSafe: true,
    supportsPhoto: true,
    suggestedRoles: ["relations-publiques", "communication-manager"],
    suggestedIndustries: ["communications", "pr"],
  ...
  },
  {
    ...
    atsSafe: false,
    supportsPhoto: true,
    suggestedRoles: ["chargee-de-communication", "community-manager"],
    suggestedIndustries: ["communication", "marketing"],
  ...
  },
  {
    ...
    suggestedIndustries: ["floristry", "nature"],
  ...
  },
  {
    ...
    atsSafe: true,
    supportsPhoto: true,
    suggestedRoles: ["community-manager", "social-media-manager"],
    suggestedIndustries: ["social-media", "marketing"],
  ...
  },
  {
    ...
    suggestedIndustries: ["illustration", "creative"],
  ...
  },
  {
    ...
    atsSafe: false,
    supportsPhoto: true,
    suggestedRoles: ["designer-graphique", "art-director"],
    suggestedIndustries: ["design", "creative"],
  ...
  // 3. Ultra-Creative Batch
  {
    ...
    suggestedIndustries: ["beauty", "cosmetics"],
  ...
  },
  {
    ...
    suggestedIndustries: ["floristry", "wellness"],
    themes: ["sage", "forest", "ivory"],
  },
  {
  ...
  // 4. Core Popular Templates
  {
    slug: "classic-serif",
    name: "Classic Serif",
    description: "Single-column, gold rule accents, Fraunces display.",
  ...
  },
  {
    ...
    description: "Peach sidebar for contact and skills, coral underline.",
    category: "professional",
  ...
  },
  {
    slug: "healthcare",
    name: "Healthcare",
    description: "Forest + sage palette, credential pills.",
    category: "medical",
  ...
  },
  {
    slug: "corporate-blue",
    name: "Corporate Blue",
    description: "Navy hero band + clean white body.",
    category: "business",
    component: CorporateBlue,
    atsSafe: true,
    supportsPhoto: true,
    suggestedRoles: ["project-manager", "operations-manager"],
  ...
  },
  {
    ...
    suggestedIndustries: ["universal", "corporate"],
    themes: ["mono", "ivory", "slate"],
  },
  {
    slug: "midnight-cyan",
    name: "Midnight Cyan",
    description: "Dark navy canvas, cyan-violet glow.",
    category: "developer",
  ...
  },
  {
    ...
    description: "Deep emerald header, gold rule for finance leaders.",
    category: "finance",
  ...
  },
  {
    ...
    suggestedIndustries: ["business", "operations"],
    themes: ["navy", "royal", "slate"],
  },
  {
    slug: "rose-editorial",
    name: "Rose Editorial",
    description: "Elegant blush palette, centered editorial masthead.",
    category: "marketing",
  ...
  },
  {
    slug: "wine-legal",
    name: "Wine Legal",
    description: "Refined wine-and-serif classic with centered headings.",
    category: "legal",
    component: WineLegal,
    atsSafe: true,
    supportsPhoto: false,
