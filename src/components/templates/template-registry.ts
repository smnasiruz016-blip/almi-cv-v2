...
// NOTE: batch-imported-canva is a SEPARATE module from batch-canva-imported above.
// These five are declared in batch-imported-canva, not batch-canva-imported. Importing
// them from the wrong module is what made the restored registry fail to type-check.
import {
...
export const TEMPLATES: TemplateMeta[] = [
  ...
  },
  {
    ...
    category: "trades-industrial",
    component: ConstructionBlueprint,
    atsSafe: false,
    supportsPhoto: false,
    addedAt: "2026-06-01T00:00:00.000Z",
    suggestedRoles: [
  ...
  {
    slug: "edu-gradient-pills",
    name: "Edu Gradient Pills",
  ...
  {
    slug: "holo-premium-light",
    name: "Holo Premium Light",
  ...
  {
    slug: "librarian-neon-wave",
    name: "Librarian Neon Wave",
  ...
  {
    slug: "medical-neon-hud",
    name: "Medical Neon HUD",
  ...
  {
    slug: "warm-minimal-dials",
    name: "Warm Minimal Dials",
