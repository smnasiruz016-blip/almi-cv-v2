...
import Healthcare from "./Healthcaimport type { ComponentType } from "react";
import type { TemplateProps } from "./types";

// Masterclass & Canva Imported Batches
import {
...
export const TEMPLATES: TemplateMeta[] = [
  ...
  // Canva Iconic Batch
  {
    ...
    description: "Classic Canva-style editorial serif with centered portrait, clean hairline borders.",
    ...
    suggestedRoles: ["marketing-lead", "brand-strategist", "consultant"],
    suggestedIndustries: ["marketing", "consulting"],
    themes: ["mono", "sand", "ivory"],
  },
  {
    slug: "olivia-wilson-terracotta",
    name: "Olivia Wilson Terracotta",
    description: "Famous Canva terracotta split-column layout with photo circle and skill bars.",
    category: "creative",
    component: OliviaWilsonTerracottaTemplate as unknown as ComponentType<TemplateProps>,
    atsSafe: false,
    supportsPhoto: true,
    addedAt: "2026-08-16T05:50:00.000Z",
    suggestedRoles: ["graphic-designer", "ui-designer", "art-director"],
    suggestedIndustries: ["creative", "design"],
    themes: ["terracotta", "sand", "linen"],
  },
  {
    slug: "pedro-fernandes-dark",
    name: "Pedro Fernandes Executive Dark",
    description: "Bold charcoal sidebar with monochrome high-contrast content blocks.",
    category: "executive",
    component: PedroFernandesDarkTemplate as unknown as ComponentType<TemplateProps>,
    atsSafe: false,
    supportsPhoto: true,
    addedAt: "2026-08-16T05:40:00.000Z",
    suggestedRoles: ["executive-director", "operations-manager", "project-director"],
    suggestedIndustries: ["executive", "operations"],
    themes: ["charcoal", "slate", "mono"],
  },
  {
    slug: "helena-morales-blush",
    name: "Helena Morales Blush & Lavender",
    description: "Gentle organic wave curves with soft pastel purple/blush palette.",
    category: "creative",
    component: HelenaMoralesBlushTemplate as unknown as ComponentType<TemplateProps>,
    atsSafe: false,
    supportsPhoto: true,
    addedAt: "2026-08-16T05:30:00.000Z",
    suggestedRoles: ["content-writer", "copywriter", "social-media-manager"],
    suggestedIndustries: ["creative", "writing"],
  ...
  // Commercial & Tech High-Impact Batch
  {
    ...
    description: "High-impact developer terminal with bash controls and KPI metric tiles.",
    category: "developer",
    component: CyberDevTerminalTemplate as unknown as ComponentType<TemplateProps>,
    atsSafe: false,
    supportsPhoto: true,
    addedAt: "2026-08-16T04:00:00.000Z",
    suggestedRoles: ["software-engineer", "full-stack-developer", "devops-engineer"],
  ...
  },
  {
    ...
    description: "High-roller luxury realty theme with skyscraper gold crest and KPI badges.",
    category: "real-estate",
    component: LuxeRealEstateTemplate as unknown as ComponentType<TemplateProps>,
    atsSafe: false,
    supportsPhoto: true,
    addedAt: "2026-08-16T03:30:00.000Z",
    suggestedRoles: ["real-estate-agent", "luxury-real-estate-broker"],
  ...
  // Medical & Clinical Batch
  {
    ...
    description: "Luxury dark emerald canvas with liquid rose gold fluid wave ribbons.",
    category: "medical",
    component: AstridEmeraldTemplate as unknown as ComponentType<TemplateProps>,
    atsSafe: false,
    supportsPhoto: true,
    addedAt: "2026-08-16T03:00:00.000Z",
    suggestedRoles: ["occupational-therapist", "physiotherapist", "clinical-director"],
    suggestedIndustries: ["healthcare", "rehabilitation"],
    themes: ["emerald", "rose", "forest"],
  },
  {
    slug: "aura-midwife",
    name: "Aura Midwife Organic",
    description: "Soft pastel organic flow with dual-ring avatar and warm coral waves.",
    category: "medical",
    component: AuraMidwifeTemplate as unknown as ComponentType<TemplateProps>,
    atsSafe: true,
    supportsPhoto: true,
    addedAt: "2026-08-16T02:30:00.000Z",
    suggestedRoles: ["midwife", "doula", "neonatal-nurse"],
    suggestedIndustries: ["healthcare", "maternity"],
    themes: ["coral", "blush", "ivory"],
  },
  {
    slug: "cyber-paramedic",
    name: "Cyber Paramedic HUD",
    description: "High-contrast dark terminal with cyan and emergency neon-red glowing rails.",
    category: "medical",
    component: CyberParamedicTemplate as unknown as ComponentType<TemplateProps>,
    atsSafe: false,
    supportsPhoto: true,
    addedAt: "2026-08-16T02:00:00.000Z",
    suggestedRoles: ["flight-paramedic", "critical-care-paramedic", "emt"],
    suggestedIndustries: ["emergency-services", "healthcare"],
    themes: ["midnight", "charcoal", "wine"],
  },
  {
    slug: "royal-dental",
    name: "Royal Dental & Surgical",
    description: "Deep imperial violet and liquid metallic gold ribbons.",
    category: "medical",
    ...
    suggestedIndustries: ["dentistry", "cosmetic-surgery"],
